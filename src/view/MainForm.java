...
public class MainForm extends javax.swing.JFrame {
    ...
    private void btnInditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInditActionPerformed
        ...
        String[] arr={"Kő", "Papír", "Olló"};
      	Random r=new Random();        
      	int randomNumber=r.nextInt(arr.length);
      	//System.out.println(arr[randomNumber]);
        gep.setText(arr[randomNumber]);
    ...
    private void jRadioButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton3ActionPerformed
        btnIndit.setEnabled(rootPaneCheckingEnabled);
        gombfelold();
    }//GEN-LAST:event_jRadioButton3ActionPerformed
    public void gombletilt() {
        jRadioButton1.setEnabled(true);
        jRadioButton2.setEnabled(true);
        jRadioButton3.setEnabled(true);
        
    }
    public void gombfelold() {
    ...
    public void mentes(){
        JOptionPane.showConfirmDialog(null, "Menteni szeretne?","Mentés",JOptionPane.YES_NO_OPTION);
    }
